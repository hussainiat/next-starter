      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6 md:gap-10">
          <Link href="/" className="flex items-center space-x-2">
            <span className="hidden font-bold sm:inline-block">Next.js Enterprise Starter</span>
          </Link>
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="text-sm leading-tight text-muted-foreground">
                            A production-ready, feature-rich starter kit for building modern web applications
                          </p>
                        </Link>
                      </NavigationMenuLink>
                    </li>
                    ...
                    <li>
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            Ready for integration with your preferred auth solution
                          </p>
                        </Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink asChild>
                        <Link
                          ...
                          className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                        >
                          <div className="text-sm font-medium leading-none">Form Handling</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
